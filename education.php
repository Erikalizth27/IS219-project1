...
<body>
	...
	<main>
		<section class="title2">
			<h2>Education</h2>
			<ul>
				<li>Passaic County Community College 
				A.A.S. Information Technology - Network Administration - May 2015</li>
				<li>New Jersey Institute of Technology 
				Bachelor of Science in Information Technology - Web Application - May 2019</li>
	...
	<aside class="asidealign">
		...
		<div class="educationimg">
				<img id="images" src="graduation.jpg" alt="education picture" height="200">
		</div>
	</aside>
	<footer>
